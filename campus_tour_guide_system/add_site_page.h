...
class AddSitePage : public QWidget {
 ...
 signals:
  ...
  void CoordinateToNode(double x, double y, Sender s = Sender::ADD_SITE_PAGE);
  ...
  void PaintRequest();
  // 请求展示已有景点信息
  void PresentInfoRequest(int id, Sender sender = Sender::ADD_SITE_PAGE);

  void DeleteInfoRequest(int node_id);
